...
from ..constants import (
    ...
    SMALLEST_BIT_DIFFICULTY_KEY, NUMBER_BLOCKS_TO_ADD_KEY, NUMBER_BLOCKS_SLICE_KEY, FIGSIZE, LEGEND_TITLE, PLOT_LABEL
)
...
def plot_blockchain_statistics(blockchain):
    ...
    plt.title(PLOT_LABEL, fontsize=PLOT_TITLE_FONT_SIZE, y=PLOT_TITLE_Y)
    plt.show()
