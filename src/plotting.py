...
# # # # #         difficulty_color: str = difficulty_colors[i % len(difficulty_colors)]
# # # # #
# # # # #         # Plot mining times as a bar chart
...
# #     marker_size = max(10, 500 / num_bars)  # Adjust marker size based on the number of bars
# #
# #     ax1.bar(
# #         range(len(mining_times)),
# #         mining_times,
...
# #         mining_times,
# #         color=mining_time_color,
# #         s=marker_size,  # dynamically adjusted size of the markers
# #         zorder=3  # ensure markers are on top
# #     )
#
#
