...
def add_blocks(blockchain: Blockchain, number_of_blocks_to_add: int) -> None:
    for _ in range(number_of_blocks_to_add):
        blockchain.add_block(blockchain.clamp_factor, blockchain.smallest_bit_difficulty)
