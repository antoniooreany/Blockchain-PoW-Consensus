...
if __name__ == "__main__":
    ...
    for base in [
        ...
        # logger.critical(f"Avarage mining time: {blockchain.get_average_block_creation_time()}")
        logger.critical(f"Avarage mining time: {blockchain.get_average_mining_time(blockchain.blocks.__len__())}")
