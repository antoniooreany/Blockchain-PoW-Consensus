...
if __name__ == "__main__":
    ...
    for base in [
        ...
        filtered_bit_difficulties = collect_filtered_bit_difficulties(
            blockchain,
            ADJUSTMENT_INTERVAL
        )  # todo skips the last bit difficulty in the adjustment interval,
        # todo ??? leading to the proof of work error ???
        blockchain.filtered_bit_difficulties = filtered_bit_difficulties  # Update the blockchain with filtered difficulties
